...
<div class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
    ...
    {{-- Panel kiri — branding --}}
    <div class="hidden lg:flex flex-col justify-between bg-gradient-to-br from-indigo-600 to-indigo-800 p-12 text-white">
        {{-- Logo --}}
        <a href="{{ url('/') }}" class="flex items-center gap-3">
            <svg class="w-9 h-9 text-white" viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
            ...
            <span class="text-2xl font-bold tracking-tight">NAMMERCE</span>
        </a>
        ...
        <div class="space-y-5">
            ...
            <p class="text-indigo-200 text-base leading-relaxed max-w-sm">
                Temukan ribuan produk berkualitas dan nikmati pengalaman belanja online yang menyenangkan.
            </p>
        ...
        {{-- Footer kiri --}}
        <p class="text-indigo-300 text-sm">&copy; {{ date('Y') }} Nammerce</p>
    </div>
    ...
    <div class="flex flex-col justify-center items-center px-6 py-12 bg-white">
        ...
        <div class="lg:hidden mb-8 flex flex-col items-center gap-2">
            <a href="{{ url('/') }}" class="flex items-center gap-2">
                ...
                <span class="text-xl font-bold text-indigo-600">{{ config('app.name', 'Nammerce') }}</span>
            </a>
        </div>
